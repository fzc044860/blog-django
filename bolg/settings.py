...
SECRET_KEY = 'django-insecure-#8k#kkr6d0c3ajs-f2(4dq=_s%pbt4ps3^0e*dhl5rhslop7uq'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'post.mycontextprocessors.getRightInfo',  #右边的分类信息
            ],
            'libraries':{'myfilter':  'post.templatetags.myfilter',}  #自定义过滤器注册
